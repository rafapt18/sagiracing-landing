...
const allVehicles = [
  { brand: "Renault", model: "Zoe Intens 50 c/ Bateria".trim(), price: 13450, year: 2021, km: 60000, cv: 109, color: "Branco", battery: "50 kWh", warranty: "18 meses", highlight: "Garantia 18 meses", img: "/cars/zoe.webp", url: "https://sagiracing.pt/carros-eletricos-usados-viana-do-castelo/63895/renault-zoe-c-bateria-intens-50" },
  { brand: "Citroën", model: "ë-C4 50 kWh Feel Pack".trim(), price: 16490, year: 2021, km: 39000, cv: 136, color: "Verde", battery: "50 kWh", warranty: "18 meses", highlight: "Cor Verde exclusiva", img: "/cars/ec4.webp", url: "https://sagiracing.pt/carros-eletricos-usados-viana-do-castelo/64404/citroen-e-c4-50-kwh-feel-pack" },

  { brand: "Peugeot", model: "e-208 50 kWh Style".trim(), price: 18980, year: 2024, km: 29000, cv: 136, color: "Preto", battery: "50 kWh", warranty: "18 meses", highlight: "Navegação · Ano 2024 — como novo", img: "/cars/e208.webp", url: "https://sagiracing.pt/carros-eletricos-usados-viana-do-castelo/64823/peugeot-e-208-50-kwh-style" },
  { brand: "Tesla", model: "Model 3 Standard RWD".trim(), price: 26890, year: 2022, km: 80000, cv: 283, color: "Branco", battery: "60 kWh", warranty: "18 meses", highlight: "IVA dedutível · Autopilot", img: "/cars/model3.webp", url: "https://sagiracing.pt/carros-eletricos-usados-viana-do-castelo/65857/tesla-model-3-standard-rwd" },
  { brand: "Renault", model: "Mégane E-Tech EV60 Techno".trim(), price: 27400, year: 2024, km: 42000, cv: 218, color: "Preto", battery: "60 kWh", warranty: "18 meses", highlight: "Navegação · Ano 2024 — como novo", img: "/cars/megane.webp", url: "https://sagiracing.pt/carros-eletricos-usados-viana-do-castelo/64817/renault-megane-e-tech-ev60-techno" },
